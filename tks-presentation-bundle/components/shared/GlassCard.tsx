...
export const GlassCard: React.FC<GlassCardProps> = ({
    ...
    return (
        <>
            <svg style={{ display: "none" }}>
                ...
                >
                    ...
                    <feDisplacementMap
                        in="SourceGraphic"
                        in2="softMap"
                        scale="20" // Reduced scale for subtlety on smaller elements
                        xChannelSelector="R"
                        yChannelSelector="G"
                    />
                </filter>
            ...
            <div
                className={cn("relative overflow-hidden transition-all duration-700", className)}
                style={{
            ...
            >
                ...
                <div
                    ...
                    style={{ background: "rgba(255, 255, 255, 0.1)" }} // Reduced opacity for dark theme compatibility
                />
                <div
